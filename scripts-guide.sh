...
echo ""
print_title "5. final-rebuild.sh"
...
echo ""
print_title "6. cleanup-and-redeploy.sh"
...
echo ""
print_title "9. check-isolation.sh"
...
echo ""
print_title "10. test-deployment.sh"
